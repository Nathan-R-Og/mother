...
OBJ_IS_NOT_TALKING  OBJ_PODUNK_HOTELBELLHOP_JTALK0-OBJ_PODUNK_HOTELBELLHOP
OBJ_MULTIPLY_BY_PARTY
OBJ_DIALOGUE UMSG::HOTELBELLHOP
OBJ_YESNO_IS_NO  OBJ_PODUNK_HOTELBELLHOP_JYESNO1-OBJ_PODUNK_HOTELBELLHOP
OBJ_TAKE_MONEY OBJ_PODUNK_HOTELBELLHOP_JTAKEMONEY2-OBJ_PODUNK_HOTELBELLHOP
...
OBJ_IS_NOT_TALKING  OBJ_YOUNGTOWN_FAKEHOTELBELLHOP_JTALK0-OBJ_YOUNGTOWN_FAKEHOTELBELLHOP
OBJ_DIALOGUE UMSG::YOUNGTOWN_HOTELBELLHOP
OBJ_YESNO_IS_NO  OBJ_YOUNGTOWN_FAKEHOTELBELLHOP_JYESNO1-OBJ_YOUNGTOWN_FAKEHOTELBELLHOP
OBJ_DIALOGUE UMSG::HOTELBELLHOP_ACCEPT
OBJ_SLEEP
...
OBJ_IS_NOT_TALKING  OBJ_PODUNK_HOTELWOMAN_JTALK0-OBJ_PODUNK_HOTELWOMAN
...
OBJ_IS_NOT_TALKING  OBJ_REINDEER_HOTELGUY_JTALK0-OBJ_REINDEER_HOTELGUY
.ifdef VER_JP
...
.addr SPRITEDEF_8A ;sprite
OBJ_IS_NOT_TALKING  OBJ_PODUNK_HOTELGUY_JTALK0-OBJ_PODUNK_HOTELGUY
...
.addr SPRITEDEF_8A ;sprite
OBJ_IS_NOT_TALKING  OBJ_MERRYSVILLE_HOTELGUY_JTALK0-OBJ_MERRYSVILLE_HOTELGUY
...
OBJ_IS_NOT_TALKING  OBJ_MERRYSVILLE_HOTELWAITER_JTALK0-OBJ_MERRYSVILLE_HOTELWAITER
...
OBJ_IS_NOT_TALKING  OBJ_MERRYSVILLE_HOTELMUSCIALGIRL_JTALK0-OBJ_MERRYSVILLE_HOTELMUSCIALGIRL
...
.addr SPRITEDEF_8A ;sprite
OBJ_IS_NOT_TALKING  OBJ_MERRYSVILLE_HOTELFAVFOODGUY_JTALK0-OBJ_MERRYSVILLE_HOTELFAVFOODGUY
