OBJ_BANK_C:
.word OBJ_GRAVEYARD_HOLEENTRANCE
.word OBJ_GRAVEYARD_DOOREXIT
.word OBJ_GRAVEYARD_HOLEEXIT
.word OBJ_GRAVEYARD_DOORENTRANCE
.word OBJ_GRAVEYARD_CASKET1
.word OBJ_GRAVEYARD_CASKET2
.word OBJ_GRAVEYARD_CASKET3
.word OBJ_GRAVEYARD_CASKET4
.word OBJ_GRAVEYARD_PIPPI
.word 0
...
.byte SCRIPTS::M_MOVE
.word OBJ_GRAVEYARD_CASKET1_MOVE0
...
OBJ_GRAVEYARD_PIPPI:
objectDef $14, $334, DIRECTIONS::DOWN, $87
.word $8080 ;sprite
...
.byte SCRIPTS::M_MOVE
.word OBJ_GRAVEYARD_PIPPI_MOVE0
.byte SCRIPTS::DIALOGUE
.word UMSG::GRAVEYARD_PIPPI_AFRAID
.byte SCRIPTS::M_MOVE
.word OBJ_GRAVEYARD_PIPPI_MOVE1
...
.byte SCRIPTS::M_MOVE
.word OBJ_GRAVEYARD_PIPPI_MOVE2
