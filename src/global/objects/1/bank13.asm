...
OBJ_IS_NOT_TOUCHING  OBJ_YUCCA_MUSICSWITCH1_JTOUCH0-OBJ_YUCCA_MUSICSWITCH1
OBJ_PLAY_MUSIC  $6
...
OBJ_IS_NOT_TOUCHING  OBJ_YUCCA_MUSICSWITCH2_JTOUCH0-OBJ_YUCCA_MUSICSWITCH2
OBJ_PLAY_MUSIC  $6
...
OBJ_IS_NOT_TOUCHING  OBJ_YUCCA_MUSICSWITCH3_JTOUCH0-OBJ_YUCCA_MUSICSWITCH3
OBJ_PLAY_MUSIC  $8
...
OBJ_IS_NOT_TOUCHING  OBJ_YUCCA_MUSICSWITCH4_JTOUCH0-OBJ_YUCCA_MUSICSWITCH4
OBJ_PLAY_MUSIC  $8
