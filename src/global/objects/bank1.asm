...
OBJ_BANK_1:
.word OBJ_MYHOME_HOUSEENTRANCE
.word OBJ_GRAVEYARD_CHURCHENTRANCE
.word OBJ_DUNCANFACTORY_ENTRANCE
.word OBJ_THING_4
.word OBJ_THING_5
.word OBJ_MYHOME_DOG
.word OBJ_PODUNK_PIPPIMOM
.word OBJ_PODUNK_PIPPI
.word OBJ_CANARY_MAN
.word OBJ_CANARY_PILLAR
.word OBJ_CANARY_LAURA
.word OBJ_CANARY_CANARY
.word OBJ_CANARY_CANARY2
.word OBJ_CANARY_CANARY3
.word OBJ_CANARY_CANARY4
.word OBJ_CANARY_CANARY5
.word OBJ_CANARY_CANARY6
.word OBJ_CANARY_CANARY7
.word OBJ_CANARY_CANARY8
.word OBJ_DUNCANFACTORY_DOG
.word OBJ_GRAVEYARD_MUSICSWAP
.word OBJ_GRAVEYARD_MUSICSWAP2
.word OBJ_CANARY_SIGN
.word OBJ_MYHOME_SIGN
.word OBJ_MTITOI_CABINDOOREXIT
.word OBJ_MTITOI_CABINCUTSCENE
.word OBJ_MTITOI_CABINHEALFAIL
.word OBJ_MTITOI_CABINHEALER
.word OBJ_MTITOI_TEDDY
.word OBJ_MTITOI_TEDDY2
.word OBJ_MTITOI_PHONE
.word OBJ_PODUNK_NOISYMOUSEENTRANCE
.word OBJ_PODUNK_NOISYMOUSE
.word 0
...
OBJ_THING_4:
objectDef $29, $B1, DIRECTIONS::UP, $13A
.byte $32
.byte 0
...
OBJ_MYHOME_DOG:
objectDef OBJ_TYPE::WANDERING_NPC2, $AC, DIRECTIONS::DOWN, $13C
;sprite
.word $85EC
...
OBJ_CANARY_MAN:
objectDef OBJ_TYPE::STATIONARY_NPC2, $5C, 4, $13A
;sprite
.word $860c
...
.byte SCRIPTS::M_MOVE
.word OBJ_DUNCANFACTORY_DOG_MOVE1
.byte SCRIPTS::B_BATTLE,$07
.byte SCRIPTS::F_SETFLAG,$7E
.byte SCRIPTS::M_MOVE
.word OBJ_DUNCANFACTORY_DOG_MOVE2
