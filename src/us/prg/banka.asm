...
.segment        "PRGA_1": absolute
        ...
        ;?????
        incbinRange "../../split/us/prg/banka.bin", $1400, $158B
...
L9B40:  lda     #.LOBYTE(NameCharacters-ramOffset)
        ...
        sta     $84
        stx     $85
        incbinRange "../../split/us/prg/banka.bin", $1C2F, $1C4E
L9C4E:  ldx     $82 ; cursor (x*width)+y value
        lda     NameCharacters-ramOffset,x
        incbinRange "../../split/us/prg/banka.bin", $1C53, $1CAF
L9CAF:  lda     ExistEntries-ramOffset,x
        incbinRange "../../split/us/prg/banka.bin", $1CB2, $1CBF
L9CBF:  lda     ExistEntries-ramOffset,x
        incbinRange "../../split/us/prg/banka.bin", $1CC2, $1f9f

.segment        "PRGA_2": absolute
